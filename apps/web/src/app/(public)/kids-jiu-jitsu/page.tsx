    ...
    <section className="flex w-full flex-col py-16">
      ...
      <div className="m-auto mt-0 flex flex-col px-4 pt-12 lg:max-w-7xl">
        ...
        <motion.div
          ...
          // viewport={{ once: true }}
          className="rounded-2xl border border-emerald-700/40 bg-gradient-to-r from-gray-900 via-gray-800/90 to-gray-900 p-10 shadow-2xl"
        >
        ...
        <div className="bg-black px-4 py-12 text-center sm:py-20">
          <motion.h2
