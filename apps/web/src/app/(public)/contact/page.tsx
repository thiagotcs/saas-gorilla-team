...
export default function Contact() {
  return (
    <section className="flex w-full flex-col py-16">
      ...
      <div className="lg:min-w-7xl m-auto mt-0 flex max-w-lg justify-around gap-8 px-4 ">
        <div className="w-full lg:max-w-[530px]">
          <ContactForm />
        </div>
        <div className="flex w-full flex-col rounded-lg bg-gray-800 p-5 py-8 pt-6 lg:max-w-[530px]">
          ...
          <p className="mb-4 flex gap-2">
            <MapPin />
            Av. Dep. José Alves dos Santos, 1494 - Parque Hortência II, Maringá
            - PR, 87075-210
          </p>
          <strong className="text-1xl mb-1">GORILLA TEAM CT4</strong>
          <p className="mb-4 flex gap-2">
            <MapPin />
